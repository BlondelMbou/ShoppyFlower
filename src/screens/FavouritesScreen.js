...
const FavouriteScreen = () => {
  const { favourites, addToCart, removeFromFavourites, decreaseFavouriteQuantity, increaseFavouriteQuantity } = useContext(CartContext); // Adjust according to your context
